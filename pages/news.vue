    ...
    <ClientOnly>
        <main class="content">
            <section class="news">
                ...
                <NewsBox :date="'15.02.2022г.'" :text="`Обсуждали понятие слова Война, говорили о страшном явлении в жизни любого народа, целях войны и последствиях её для всех сторон. Война в Афганистане носила миротворческой характер, но сколько бед в жизнь советских семей она принесла. А ведь именно
                ...
                <NewsBox :date="'08.02.2022г.'" :text="'Запустили челендж ко Дню науки 8 февраля.'"
